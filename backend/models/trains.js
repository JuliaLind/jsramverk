 ...
 */
function parsePositionData(data, trainPositions, socket) {
    try {
 ...
 * @param {Object} e - The SSE message event.
 * @param {Object} trainPositions - Object to store train positions.
 * @param {Object} socket - The WebSocket connection.
 */
function handleSSEMessage(e, trainPositions, socket) {
    try {
        parsePositionData(e.data, trainPositions, socket);
    } catch (error) {
...
async function fetchTrainPositions(io) {
    try {
        ...
        io.on('connection', (socket) => {
            ...
            eventSource.onmessage = (e) => handleSSEMessage(e, trainPositions, socket);
        });
